...
namespace UnitTestSinglyLinkedLists
{
    ...
    public class UnitTestSinglyLinkedList
    {
        ...
        public void ElementAtNegativeIndex()
        {
            ...
            list.AddLast("grille");
            list.ElementAt(-2);
            //Assert.AreEqual(list.ElementAt(-3), "foo");
            //Assert.AreEqual(list.ElementAt(-2), "bar");
            //Assert.AreEqual(list.ElementAt(-1), "grille");
        ...
        public void AddAfter()
        {
            ...
            // It is merely here to remind you of / verify the state
            // of the list prior to inserting the new node.
